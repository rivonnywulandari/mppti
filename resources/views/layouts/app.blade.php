...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Sistem Informasi OR Laboratory of BI') }}</title>
        ...
        {{-- Side Bar --}}
            <div class="flex">
                <div class="w-64 bg-blue-500 h-screen">
                    <div class="flex flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
                        ...
                        <div class="flex flex-col items-center mt-6 -mx-2">
                            ...
                            <h4 class="mx-2 mt-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Admin</h4>
                            <p class="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400 hover:underline">kintanputi@gmail.com</p>
                            <div class="mt-2 border-2 px-2 rounded-full border-light-blue-500 border-opacity-100">
                               <p class="font-medium text-gray-600 dark:text-gray-400 text-xs">status: terdaftar</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col justify-between flex-1 mt-6">
                            <nav>
                                ...
                                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                    ...
                                    <span class="mx-4 font-medium">Berkas Pendaftaran</span>
                                </a>
                ...
                <div class="w-full flex flex-col">
                    <div class="header w-full bg-blue-400 h-16 container p-4">
                        Header
                    </div>
                    <div class="content w-full bg-gray-100 h-full p-4">
