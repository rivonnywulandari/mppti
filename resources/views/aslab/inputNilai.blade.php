      ...
      @csrf
        <div class="shadow overflow-hidden sm:rounded-md">
          ...
          <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
              <b>Input Nilai {{ $jenis->nama_seleksi }}</b>
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <input type="text" name="nama" id="nama" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ $tampil->name }}" readonly>
                </div>

              <div class="col-span-6 sm:col-span-4">
                <label for="nilai" class="block text-sm font-medium text-gray-700">Nilai</label>
                <input type="text" name="nilai" id="nilai" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Nilai">
              </div>

              <div class="col-span-6 sm:col-span-4">
                <label for="keterangan" class="block text-sm font-medium text-gray-700">Keterangan</label>
                <textarea type="text" name="keterangan" id="keterangan" autocomplete="given-nim" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Keterangan"></textarea>
              </div>
        </div>
      </div>
